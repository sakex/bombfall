...
clean_scene()
cube((1.0, 2.0, 1.0), (0, 0, 0), METAL_CHROME, bevel=0.06)
cube((0.84, 0.06, 0.84), (0, -1.02, 0), METAL_STEEL, bevel=0.02)
for sx in (-1, 1):
    for sz in (-1, 1):
        sphere(0.06, (sx * 0.36, -1.06, sz * 0.36), METAL_DARK, segments=8, rings=6)
