...
T = 0.12
ROT = (math.pi / 2, 0, 0)
cyl(R, T, (0, 0, 0), METAL_GOLD, rot=ROT, verts=28, bevel=0.02)
torus(R * 0.86, 0.03, (0, -T / 2, 0), METAL_BRASS, rot=ROT, major_segments=28)
torus(R * 0.86, 0.03, (0, T / 2, 0), METAL_BRASS, rot=ROT, major_segments=28)
...
for y in (-T / 2 - 0.01, T / 2 + 0.01):
    torus(R * 0.45, 0.025, (0, y, 0), GLOW, rot=ROT, major_segments=20, minor_segments=6)
    for a in (0, math.pi / 2):
        cube((0.55, 0.03, 0.05), (0, y, 0), GLOW, rot=(0, a, 0), bevel=0)
    for a in range(4):
        ang = a * math.pi / 2 + math.pi / 4
        sphere(0.045, (math.cos(ang) * R * 0.66, y, math.sin(ang) * R * 0.66), GLOW, segments=8, rings=6)
