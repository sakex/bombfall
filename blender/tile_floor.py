...
clean_scene()
D = 2.0
cube((1.0, D, 1.0), (0, 0, 0), METAL_DARK, bevel=0.06)
# Raised plate on the front face with a slot of neon light.
cube((0.80, 0.08, 0.80), (0, -D / 2 - 0.02, 0), (SLATE, 0.5, 0.6), bevel=0.03)
...
cube((0.86, 1.2, 0.05), (0, 0.15, 0.50), (SLATE, 0.55, 0.5), bevel=0.01)
for i in range(3):
