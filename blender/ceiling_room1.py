...
sphere(0.16, (7.5, D - 1.0, -0.55), METAL_BRASS, segments=10, rings=8)
for i in range(4):
    a = i * math.pi / 2
    cube((1.1, 0.24, 0.03), (7.5 + math.cos(a) * 0.65, D - 1.0 + math.sin(a) * 0.65, -0.55), (WOOD, 0.7, 0.0), rot=(0, 0.15, a), bevel=0.01)
